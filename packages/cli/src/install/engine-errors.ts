...
const stageExit: Record<InstallRuntimeStage, ExitCode> = {
  ...
  verify: EXIT_CODES.POST_INSTALL_OR_ROLLBACK_FAILURE,
  assets: EXIT_CODES.CONTRACT,
  settings: EXIT_CODES.CONTRACT,
  dump: EXIT_CODES.POST_INSTALL_OR_ROLLBACK_FAILURE,
  doctor: EXIT_CODES.POST_INSTALL_OR_ROLLBACK_FAILURE,
  metadata: EXIT_CODES.POST_INSTALL_OR_ROLLBACK_FAILURE,
};
